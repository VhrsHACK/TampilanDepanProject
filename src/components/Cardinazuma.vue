...
<template>
  ...
  <div class="slider" id="mySlider">
    <h1 class="bold text-light" style="margin-right: 100%;">Inazuma</h1>
      ...
      <img :src="card.image" alt="" srcset=""/>
       <div class="description">
        <div class="description__text-container">
          ...
          <router-link class="btn btn-primary" :to="'/detailinazuma/' + card._id">
...
export default {
  ...
  mounted() {
    axios
      .get("https://projectuas-one.vercel.app/inazuma")
      .then((response) => {
