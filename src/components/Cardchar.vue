...
<template>
  ...
  <div class="slider" id="mySlider">
    <h1 class="bold text-light" style="margin-right: 100%;">Mondstadt</h1>
      ...
      <img :src="card.image" alt="" srcset=""/>
       <div class="description">
        <div class="description__text-container">
          ...
          <router-link class="btn btn-primary" :to="'/detailkarakter/' + card._id">
...
export default {
  ...
  mounted() {
    axios
      .get("https://projectuas-one.vercel.app/mondo")
      .then((response) => {
